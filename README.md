# machuruku
Machuruku is an R package developed with [Wilson X. Guillory](https://scholar.google.com/citations?user=a_n1uCIAAAAJ&hl=en) for phylogenetic niche modeling and estimating ancestral distributions.  Machuruku, named after the Quechua word for 'ancient', uses a modified Bioclim niche-modeling method and ancestral character estimation to reconstruct ancestral niches. Input data consists of present-day climate rasters, a time-calibrated phylogeny, and taxon occurrence data for all tips. Ancestral niche models can then be projected into additionally provided paleoclimate data (www.paleoclim.org) to visualize the potential distributions of evolving lineages across time and sapce. The most update version of this is hosted on Wilson's Github: https://github.com/wxguillo/machuruku. Please stay tunned for the assocaited paper coming soon in Systematic Biology!
